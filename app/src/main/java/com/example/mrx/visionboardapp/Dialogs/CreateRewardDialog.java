...
public class CreateRewardDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.create_reward_edittext).requestFocus();
        Dialog dialog = builder.setView(view)
                .setTitle(R.string.create_reward)
                .setPositiveButton(R.string.create, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String rewardName = ((TextInputEditText) view.findViewById(R.id.create_reward_edittext)).getText().toString();
                        String rewardPrice = ((TextInputEditText) view.findViewById(R.id.create_reward_price_edittext)).getText().toString();
